    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('border_size', models.CharField(blank=True, max_length=30, null=True, verbose_name='Tamanho da borda')),
                ('border_radius', models.CharField(blank=True, max_length=30, null=True, verbose_name='Arredondamento')),
            ],
            options={
                'abstract': False,
            },
